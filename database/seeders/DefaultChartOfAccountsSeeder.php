...
class DefaultChartOfAccountsSeeder extends Seeder
{
    ...
    protected function definitions(): array
    {
        return [
            ...
            ['code' => '4000', 'name' => 'Income', 'type' => 'income', 'classification' => 'header', 'allows_manual_entries' => false],
            ['code' => '4100', 'name' => 'Sales Income', 'type' => 'income', 'classification' => 'header', 'parent_code' => '4000', 'allows_manual_entries' => false],
            ['code' => '4110', 'name' => 'Product Sales Revenue', 'type' => 'income', 'subtype' => 'sales', 'parent_code' => '4100'],
            ['code' => '4120', 'name' => 'Shipping Revenue', 'type' => 'income', 'subtype' => 'shipping_income', 'parent_code' => '4100'],
            ['code' => '4130', 'name' => 'Service Fee Income', 'type' => 'income', 'subtype' => 'service_fee', 'parent_code' => '4100'],
            ['code' => '4140', 'name' => 'Other Income', 'type' => 'income', 'subtype' => 'other_income', 'parent_code' => '4100'],
            ['code' => '4150', 'name' => 'Sales Discount Contra Revenue', 'type' => 'income', 'subtype' => 'contra_revenue', 'parent_code' => '4100'],
            ['code' => '4160', 'name' => 'Inventory Adjustment Gain', 'type' => 'income', 'subtype' => 'inventory_gain', 'parent_code' => '4100'],

            ['code' => '5000', 'name' => 'Expenses', 'type' => 'expense', 'classification' => 'header', 'allows_manual_entries' => false],
            ['code' => '5100', 'name' => 'Cost of Sales', 'type' => 'expense', 'classification' => 'header', 'parent_code' => '5000', 'allows_manual_entries' => false],
            ['code' => '5110', 'name' => 'Cost of Goods Sold', 'type' => 'expense', 'subtype' => 'cogs', 'parent_code' => '5100'],
            ['code' => '5120', 'name' => 'Shipping Expense', 'type' => 'expense', 'subtype' => 'shipping_expense', 'parent_code' => '5100'],
            ['code' => '5130', 'name' => 'Payment Gateway Charges', 'type' => 'expense', 'subtype' => 'gateway_charge', 'parent_code' => '5100'],
