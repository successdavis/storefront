...
const adminNavItems: SidebarNavItem[] = [
    ...
    },
    {
        ...
        subItems: [
            ...
            { title: 'Charts', href: '/admin/accounting/charts', condition: 'can_view_accounting' },
            ...
            { title: 'Cash Deposits', href: '/admin/accounting/cash-bank-transfers', condition: 'can_manage_accounting' },
            ...
            { title: 'Inventory Valuation', href: '/admin/accounting/reports/inventory-valuation', condition: 'can_view_accounting_reports' },
            { title: 'Balance Sheet', href: '/admin/accounting/reports/balance-sheet', condition: 'can_view_accounting_reports' },
            { title: 'Cash Summary', href: '/admin/accounting/reports/cash-summary', condition: 'can_view_accounting_reports' },
            { title: 'Receivables', href: '/admin/accounting/reports/receivables', condition: 'can_view_accounting_reports' },
        ],
