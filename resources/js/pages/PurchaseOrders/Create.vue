    ...
    <div class="mx-auto max-w-6xl p-6">
        ...
        <form @submit.prevent="submit" class="space-y-6" novalidate>
            ...
            <section class="rounded-lg border bg-white p-4">
                            ...
                            <td class="px-3 py-2 align-top">
                                <div class="flex gap-2">
                                    <button
                                        ...
                                        title="Duplicate row"
                                        class="rounded-lg border px-2 py-1 hover:bg-gray-50"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            class="h-4 w-4"
                                    ...
                                    <button
                                        type="button"
                                        @click="removeRow(idx)"
                                        class="rounded-lg border px-2 py-1 text-red-600 hover:bg-red-50"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            class="h-4 w-4"
                ...
                <div v-if="itemErrorsExist" class="mt-3 text-sm text-red-600">
            ...
            <div class="flex items-center justify-between gap-4">
                <div class="text-sm text-muted-foreground">
                    <p>
                        After saving, you can send the PO to the vendor or edit
                        it while it's still a draft.
                    </p>
                </div>
                ...
                <div class="flex items-center gap-3">
                    <Link
                        ...
                        class="inline-flex items-center gap-2 rounded-lg border bg-red-300 px-4 py-2 hover:bg-gray-50"
                    >
                        Cancel
                    </Link>
                    ...
                    <button
                        ...
                        class="hover:bg-primary-700 inline-flex cursor-pointer items-center gap-2 rounded-lg bg-blue-900 px-4 py-2 text-white disabled:opacity-50"
                    >
                        <svg
        ...
        <!-- Modal with reusable VendorForm -->
        <div
